...
jobTriggered: 'Job ejecutado',
  ...
  settings: {
    ...
    session: {
      ...
      workspaceBaseHint: 'Directorio absoluto usado como raiz para explorar workspaces y acceder a archivos absolutos. Dejalo vacio para usar el directorio home.',
      workspaceBasePlaceholder: '/Users/name/projects',
      workspaceBaseEffective: 'Raiz efectiva: {path}',
      workspaceBaseSourceEnv: 'desde WORKSPACE_BASE',
      workspaceBaseSourceApp: 'desde configuracion',
      workspaceBaseSourceHome: 'directorio home predeterminado',
      workspaceBaseEnvLocked: 'WORKSPACE_BASE esta definido, por lo que los cambios de configuracion no se activaran.',
      workspaceBaseEnvOverride: 'WORKSPACE_BASE esta definido como {path}. Quitalo del entorno o del archivo .env del repositorio y reinicia el servidor para usar esta configuracion.',
