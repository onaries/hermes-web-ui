export default {
  ...
  settings: {
    ...
    session: {
      workspaceBase: 'Base Workspace',
      workspaceBaseHint: 'Absolute directory used as the root for workspace browsing and absolute workspace file access. Leave empty to use the home directory.',
      workspaceBasePlaceholder: '/Users/name/projects',
      workspaceBaseEffective: 'Effective root: {path}',
      workspaceBaseSourceEnv: 'from WORKSPACE_BASE',
      workspaceBaseSourceApp: 'from settings',
      workspaceBaseSourceHome: 'default home directory',
      workspaceBaseEnvLocked: 'WORKSPACE_BASE is set, so settings changes cannot become active.',
      workspaceBaseEnvOverride: 'WORKSPACE_BASE is currently set to {path}. Remove it from the environment or the repository .env file, then restart the server to use this setting.',
      mode: 'Reset Mode',
