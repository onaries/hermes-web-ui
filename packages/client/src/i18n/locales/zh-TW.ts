export default {
  ...
  settings: {
    ...
    session: {
      workspaceBase: '基礎 Workspace',
      workspaceBaseHint: '作為 workspace 瀏覽與絕對路徑檔案存取根目錄的絕對目錄。留空則使用家目錄。',
      workspaceBasePlaceholder: '/Users/name/projects',
      workspaceBaseEffective: '實際根目錄：{path}',
      workspaceBaseSourceEnv: '來自 WORKSPACE_BASE',
      workspaceBaseSourceApp: '來自設定',
      workspaceBaseSourceHome: '預設家目錄',
      workspaceBaseEnvLocked: 'WORKSPACE_BASE 已設定，因此這裡的設定變更不會生效。',
      workspaceBaseEnvOverride: '目前 WORKSPACE_BASE 設為 {path}。請從環境或儲存庫 .env 檔移除，然後重新啟動伺服器以使用此設定。',
      mode: '重設模式',
