...
jobTriggered: 'Job ausgelost',
  ...
  settings: {
    ...
    session: {
      workspaceBase: 'Basis-Workspace',
      workspaceBaseHint: 'Absolutes Verzeichnis als Root fur Workspace-Browsing und absolute Workspace-Dateizugriffe. Leer lassen fur das Home-Verzeichnis.',
      workspaceBasePlaceholder: '/Users/name/projects',
      workspaceBaseEffective: 'Aktive Root: {path}',
      workspaceBaseSourceEnv: 'aus WORKSPACE_BASE',
      workspaceBaseSourceApp: 'aus Einstellungen',
      workspaceBaseSourceHome: 'Standard-Home-Verzeichnis',
      workspaceBaseEnvLocked: 'WORKSPACE_BASE ist gesetzt, daher werden Anderungen hier nicht aktiv.',
      workspaceBaseEnvOverride: 'WORKSPACE_BASE ist derzeit auf {path} gesetzt. Entferne es aus der Umgebung oder der Repository-.env-Datei und starte den Server neu, um diese Einstellung zu verwenden.',
