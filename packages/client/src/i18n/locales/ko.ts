export default {
  ...
  settings: {
    ...
    session: {
      workspaceBase: '기본 Workspace',
      workspaceBaseHint: 'Workspace 탐색과 절대 workspace 파일 접근의 루트로 사용할 절대 경로입니다. 비우면 홈 디렉터리를 사용합니다.',
      workspaceBasePlaceholder: '/Users/name/projects',
      workspaceBaseEffective: '적용 루트: {path}',
      workspaceBaseSourceEnv: 'WORKSPACE_BASE에서 가져옴',
      workspaceBaseSourceApp: '설정에서 가져옴',
      workspaceBaseSourceHome: '기본 홈 디렉터리',
      workspaceBaseEnvLocked: 'WORKSPACE_BASE가 설정되어 있어 설정 변경이 적용될 수 없습니다.',
      workspaceBaseEnvOverride: '현재 WORKSPACE_BASE가 {path}(으)로 설정되어 있습니다. 이 설정을 사용하려면 환경 변수나 저장소 .env 파일에서 제거한 뒤 서버를 다시 시작하세요.',
      mode: '초기화 모드',
