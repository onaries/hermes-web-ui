...
jobTriggered: 'Job declenche',
  ...
  settings: {
    ...
    session: {
      workspaceBase: 'Workspace de base',
      workspaceBaseHint: 'Dossier absolu utilise comme racine pour parcourir les workspaces et acceder aux fichiers absolus. Laisser vide pour utiliser le dossier personnel.',
      workspaceBasePlaceholder: '/Users/name/projects',
      workspaceBaseEffective: 'Racine effective : {path}',
      workspaceBaseSourceEnv: 'depuis WORKSPACE_BASE',
      workspaceBaseSourceApp: 'depuis les reglages',
      workspaceBaseSourceHome: 'dossier personnel par defaut',
      workspaceBaseEnvLocked: 'WORKSPACE_BASE est defini, donc les changements de reglages ne peuvent pas devenir actifs.',
      workspaceBaseEnvOverride: 'WORKSPACE_BASE vaut actuellement {path}. Retirez-le de l environnement ou du fichier .env du depot, puis redemarrez le serveur pour utiliser ce reglage.',
