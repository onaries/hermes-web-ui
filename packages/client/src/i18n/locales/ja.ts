export default {
  ...
  settings: {
    ...
    session: {
      ...
      workspaceBaseHint: 'Workspace の参照と絶対パスの workspace file access に使う root directory です。空にすると home directory を使います。',
      workspaceBasePlaceholder: '/Users/name/projects',
      workspaceBaseEffective: '有効な root: {path}',
      workspaceBaseSourceEnv: 'WORKSPACE_BASE から',
      workspaceBaseSourceApp: '設定から',
      workspaceBaseSourceHome: 'default home directory',
      workspaceBaseEnvLocked: 'WORKSPACE_BASE が設定されているため、settings の変更は有効になりません。',
      workspaceBaseEnvOverride: '現在 WORKSPACE_BASE は {path} に設定されています。この設定を使うには environment または repository の .env file から削除し、server を再起動してください。',
      mode: 'リセットモード',
