export default {
  ...
  settings: {
    ...
    session: {
      workspaceBase: '基础 Workspace',
      workspaceBaseHint: '作为 workspace 浏览和绝对路径文件访问根目录的绝对目录。留空则使用主目录。',
      workspaceBasePlaceholder: '/Users/name/projects',
      workspaceBaseEffective: '实际根目录：{path}',
      workspaceBaseSourceEnv: '来自 WORKSPACE_BASE',
      workspaceBaseSourceApp: '来自设置',
      workspaceBaseSourceHome: '默认主目录',
      workspaceBaseEnvLocked: 'WORKSPACE_BASE 已设置，因此这里的设置变更不会生效。',
      workspaceBaseEnvOverride: '当前 WORKSPACE_BASE 设置为 {path}。请从环境或仓库 .env 文件中移除，然后重启服务器以使用此设置。',
      mode: '重置模式',
      modeHint: '会话重置的触发条件',
      modeBoth: '空闲 + 定时',
      modeIdle: '仅空闲',
