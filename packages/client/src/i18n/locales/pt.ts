...
jobTriggered: 'Job acionado',
  ...
  settings: {
    ...
    session: {
      ...
      workspaceBaseHint: 'Diretorio absoluto usado como raiz para navegar workspaces e acessar arquivos absolutos. Deixe vazio para usar o diretorio home.',
      workspaceBasePlaceholder: '/Users/name/projects',
      workspaceBaseEffective: 'Raiz efetiva: {path}',
      workspaceBaseSourceEnv: 'de WORKSPACE_BASE',
      workspaceBaseSourceApp: 'das configuracoes',
      workspaceBaseSourceHome: 'diretorio home padrao',
      workspaceBaseEnvLocked: 'WORKSPACE_BASE esta definido, entao alteracoes nas configuracoes nao ficam ativas.',
      workspaceBaseEnvOverride: 'WORKSPACE_BASE esta definido como {path}. Remova do ambiente ou do arquivo .env do repositorio e reinicie o servidor para usar esta configuracao.',
